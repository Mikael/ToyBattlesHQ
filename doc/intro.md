...
## 1.1.1 ToyBattles
**ToyBattles** is a **private** MicroVolts server, completely free to play.
There's always been an official server somewhere, or other private servers like ToyHeroes, but what makes ToyBattles completely different is the free to play (for real!) nature. 
There's no payment involved at all: in-game currency, RockTokens included, is obtained purely through gameplay and events.
...
- A lot of custom changes in the client, including but not limited to:
  - Changes to the constant database (`cgd.dip`),
  - Client executable patches,
...
- [Kixra](https://github.com/kixrababyy): She mainly works on the design side. For example, the ToyBattles custom launcher is the result of her own efforts.
