...
PACK_PUSH(1)
		struct LobbyAccountInfo
		{
			...
			explicit LobbyAccountInfo(const Main::Structures::AccountInfo& accountInfo)
				...
				, latestCharacterSelected{ static_cast<std::uint32_t>(accountInfo.latestSelectedCharacter) }, infected{ accountInfo.infected }, vipExperience{ 2 }
				...
				, clanDeaths{ accountInfo.clanDeaths }, clanAssists{ accountInfo.clanAssists }, achievements{ accountInfo.achievements }
			{
